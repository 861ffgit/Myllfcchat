    ...
    ui(new Ui::UserInfoPage)
{
    ui->setupUi(this);
    this->setStyleSheet(
        "QWidget#UserInfoPage{background:#f6f8fb;}"
        "QWidget#card_wid{background:#ffffff;border:1px solid #e6edf3;border-radius:22px;}"
        "QLabel#label_4{color:#17212b;font:600 22px 'Microsoft YaHei';}"
        "QLabel#label,QLabel#label_2,QLabel#label_3{color:#7f8c98;font:13px 'Microsoft YaHei';}"
        "QLabel#head_lb{background:#f4f7fa;border:1px solid #e2e8ef;border-radius:18px;}"
        "QLineEdit{background:#ffffff;border:1px solid #dfe5eb;border-radius:10px;color:#1b2430;padding:0 12px;min-height:36px;font:14px 'Microsoft YaHei';}"
        "QLineEdit:focus{border:1px solid #9fd9b6;}"
        "QPushButton#up_btn{background:#ffffff;color:#1b2430;border:1px solid #dfe5eb;border-radius:10px;min-height:36px;padding:0 18px;font:14px 'Microsoft YaHei';}"
        "QPushButton#up_btn:hover{background:#f8fbfd;border:1px solid #cfd9e2;}"
        "QPushButton#submit_btn{background:#07c160;color:#ffffff;border:none;border-radius:10px;min-height:36px;padding:0 22px;font:600 14px 'Microsoft YaHei';}"
        "QPushButton#submit_btn:hover{background:#06d06a;}"
    );
